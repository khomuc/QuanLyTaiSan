...
- Xoa tai san sau khi da ban/thanh ly
- Import Excel
- Export Excel
...
| 6 | Them tai san | POST /api/assets | Du lieu hop le | Them moi thanh cong, co audit log ASSET_CREATE | Chua test |
| 7 | Them tai san trung ma | POST /api/assets | MaTaiSan da ton tai | Tra ve loi trung du lieu | Chua test |
| 8 | Sua tai san | PATCH /api/assets/:maTaiSan | Doi GhiChu/TrangThai | Cap nhat DB thanh cong, co audit log ASSET_EDIT | Chua test |
| 9 | Dua vao thanh ly | DELETE /api/assets/:maTaiSan | Tai san ton tai | TrangThai doi thanh HONG | Chua test |
| 10 | Xoa sau thanh ly | DELETE /api/assets/:maTaiSan/finalize | Tai san TrangThai=HONG | Tai san bi xoa khoi danh sach | Chua test |
| 11 | Lay lich su tai san | GET /api/assets/history/:maTaiSan | Tai san da tung sua | Tra ve danh sach audit log lien quan | Chua test |
| 12 | Tai file mau Excel | GET /api/assets/import-template | Co JWT hop le | Tai file mau .xlsx | Chua test |
| 13 | Import Excel | POST /api/assets/import | File Excel hop le | Import thanh cong, co so dong success | Chua test |
| 14 | Export Excel | GET /api/assets/export | Co JWT hop le | Tai file danh-sach-tai-san.xlsx | Chua test |
| 15 | Bao cao tai san | GET /api/assets/report | Co JWT hop le | Tra ve summary, byCategory, byDepartment, byStatus | Chua test |
...
| 9 | Audit log tai san | Sua tai san roi mo chi tiet | Lich su thay doi co ASSET_EDIT | Chua test |
| 10 | Dua vao thanh ly | Bam nut xoa o danh sach chinh | Tai san chuyen xuong muc Tai san thanh ly | Chua test |
| 11 | Xoa sau ban | Bam Da ban / Xoa trong muc thanh ly | Tai san bien mat sau refresh | Chua test |
| 12 | Tai file mau | Bam Tai mau Excel | Tai file mau import | Chua test |
| 13 | Import Excel | Chon file import hop le | Them tai san tu file Excel | Chua test |
| 14 | Export Excel | Bam Export Excel | Tai file Excel danh sach tai san | Chua test |
| 15 | Bao cao tai san | Vao menu Bao cao tai san | Hien KPI va thong ke theo loai/phong ban/trang thai | Chua test |
...
- TrangThai chi nhan HOAT_DONG, BAO_TRI, HONG
...
| 3 | Xoa tai san sau thanh ly bi loi foreign key | Tai san con du lieu trong chi tiet dieu chuyen/kiem ke | Xoa chi tiet lien quan truoc khi xoa TAI_SAN | Da xu ly |
