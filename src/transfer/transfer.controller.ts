...
export class TransferController {
  ...
  @Post('slips/:soPhieu/confirm-receipt')
  confirmReceipt(@Param('soPhieu') soPhieu: string, @Body() dto: ConfirmReceiptDto): Promise<any> {
    return this.transferService.confirmReceipt(soPhieu, dto);
  }
